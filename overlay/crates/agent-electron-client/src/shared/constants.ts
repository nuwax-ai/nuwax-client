...
export const I18N_KEYS = {
  Toolbar: {
    ABOUT: "Claw.Toolbar.about",
    FILE: "Claw.Toolbar.file",
    EDIT: "Claw.Toolbar.edit",
    WINDOW: "Claw.Toolbar.window",
    HELP: "Claw.Toolbar.help",
    ABOUTUPDATE: "Claw.Toolbar.aboutUpdate",
    NEWTASK: "Claw.Toolbar.newTask",
    SEARCH: "Claw.Toolbar.search",
    MODIFYWORKSPACE: "Claw.Toolbar.modifyWorkspace",
    OPENWORKSPACE: "Claw.Toolbar.openWorkspace",
    MINIMIZE: "Claw.Toolbar.minimize",
    MAXIMIZE: "Claw.Toolbar.maximize",
    RESTORE: "Claw.Toolbar.restore",
    OPENLOGS: "Claw.Toolbar.openLogs",
    EXPANDSIDEBAR: "Claw.Toolbar.expandSidebar",
    COLLAPSESIDEBAR: "Claw.Toolbar.collapseSidebar",
  },
  // 通用 Common
  Common: {
